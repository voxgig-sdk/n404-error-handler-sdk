...
class ErrorHandlingEntity extends N404ErrorHandlerEntityBase_1.N404ErrorHandlerEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'error_handling';
        this.name_ = 'error_handling';
        this.Name = 'ErrorHandling';
    }
    make() {
        return new ErrorHandlingEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<ErrorHandling[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.ErrorHandlingEntity = ErrorHandlingEntity;
//# sourceMappingURL=ErrorHandlingEntity.js.map