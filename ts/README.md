...
The TypeScript SDK for the N404ErrorHandler API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new N404ErrorHandlerSDK({ apikey: '...' })
