# N404ErrorHandler TypeScript SDK



The TypeScript SDK for the N404ErrorHandler API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.ErrorHandling()` — each with a small set of operations (`list`)
...
```ts
new N404ErrorHandlerSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| Method | Returns | Description |
| --- | --- | --- |
| `N404ErrorHandlerSDK.test(testopts?, sdkopts?)` | `N404ErrorHandlerSDK` | Create a test-mode client. |
...
n404-error-handler/
├── src/
│   ├── N404ErrorHandlerSDK.ts        # Main SDK class
