...
(0, node_test_1.describe)('ErrorHandlingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.N404ErrorHandlerSDK({
    ...
    (0, node_test_1.test)('direct-list-error_handling', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-error_handling', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.N404_ERROR_HANDLER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.N404ErrorHandlerSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['N404_ERROR_HANDLER_TEST_ERROR_HANDLING_ENTID'];
    ...
    const client = new __1.N404ErrorHandlerSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ErrorHandlingDirect.test.js.map