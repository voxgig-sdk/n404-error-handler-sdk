...
type N404ErrorHandlerSDK struct {
	Mode     string
...
func (sdk *N404ErrorHandlerSDK) OptionsMap() map[string]any {
...
func (sdk *N404ErrorHandlerSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *N404ErrorHandlerSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *N404ErrorHandlerSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *N404ErrorHandlerSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *N404ErrorHandlerSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *N404ErrorHandlerSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("N404ErrorHandlerSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *N404ErrorHandlerSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *N404ErrorHandlerSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("N404ErrorHandlerSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *N404ErrorHandlerSDK {
	...
	sdk := NewN404ErrorHandlerSDK(sdkopts)
	sdk.Mode = "test"
