...
type ErrorHandlingEntity struct {
	name    string
	client  *core.N404ErrorHandlerSDK
...
func NewErrorHandlingEntity(client *core.N404ErrorHandlerSDK, entopts map[string]any) *ErrorHandlingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ErrorHandlingEntity) GetName() string { return e.name }
...
func (e *ErrorHandlingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ErrorHandlingEntity) Deleted() bool {
	return e.deleted
}


func (e *ErrorHandlingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewErrorHandlingEntity(e.client, opts)
}

func (e *ErrorHandlingEntity) Data(args ...any) any {
...
func (e *ErrorHandlingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ErrorHandling; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ErrorHandlingEntity) DataTyped(data ...ErrorHandling) ErrorHandling {
	if len(data) > 0 {
		return typedFrom[ErrorHandling](e.Data(asMap(data[0])))
	}
	return typedFrom[ErrorHandling](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ErrorHandling (all fields
// optional at the wire level).
func (e *ErrorHandlingEntity) MatchTyped(match ...ErrorHandling) ErrorHandling {
	if len(match) > 0 {
		return typedFrom[ErrorHandling](e.Match(asMap(match[0])))
	}
	return typedFrom[ErrorHandling](e.Match())
}
...
func (e *ErrorHandlingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ErrorHandlingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ErrorHandlingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ErrorHandlingListMatch and returns []ErrorHandling. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ErrorHandlingEntity) ListTyped(reqmatch ErrorHandlingListMatch, ctrl map[string]any) ([]ErrorHandling, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ErrorHandling](res), nil
}



func (e *ErrorHandlingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ErrorHandlingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ErrorHandlingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ErrorHandlingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
