// Command N404ErrorHandler-mcp is an MCP server exposing the N404ErrorHandler
// SDK as MCP tools.
//
// Two tools are registered:
//
//	N404ErrorHandler_list  — list records of an entity
//	N404ErrorHandler_load  — load a single record of an entity
//
