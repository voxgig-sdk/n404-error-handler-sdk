...
type Args struct {
	Entity string         `json:"entity" jsonschema:"error_handling"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.N404ErrorHandlerSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "n404-error-handler_list",
		Description: "List records from N404ErrorHandler. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "n404-error-handler_load",
		Description: "Load a single record from N404ErrorHandler. " +
...
func runOp(client *sdk.N404ErrorHandlerSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.N404ErrorHandlerSDK, name string) (sdk.N404ErrorHandlerEntity, error) {
	switch strings.ToLower(name) {
	case "error_handling":
		return client.ErrorHandling(nil), nil
