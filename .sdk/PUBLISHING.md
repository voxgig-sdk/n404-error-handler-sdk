...
|---|---|---|
| `ts/` | @voxgig-sdk/n404-error-handler-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/n404-error-handler-sdk \
      --repository voxgig-sdk/n404-error-handler-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/n404-error-handler-sdk` shows it, and
`npm trust revoke @voxgig-sdk/n404-error-handler-sdk --id=<id>` removes it.
