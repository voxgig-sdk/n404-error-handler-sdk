...
// N404ErrorHandler SDK pipeline test
//
...
{
    private static function utility(): N404ErrorHandlerUtility
    {
        return new N404ErrorHandlerUtility();
    }
    ...
    private static function ctx(array $over = []): N404ErrorHandlerContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new N404ErrorHandlerContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new N404ErrorHandlerOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof N404ErrorHandlerError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new N404ErrorHandlerOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = N404ErrorHandlerMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new N404ErrorHandlerOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = N404ErrorHandlerMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new N404ErrorHandlerOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = N404ErrorHandlerMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new N404ErrorHandlerSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = N404ErrorHandlerMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new N404ErrorHandlerResponse([]),
            'result' => new N404ErrorHandlerResult([]),
        ]);
        [, $err] = N404ErrorHandlerMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new N404ErrorHandlerSpec([]),
            'response' => null,
            'result' => new N404ErrorHandlerResult([]),
        ]);
        [, $err] = N404ErrorHandlerMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new N404ErrorHandlerSpec(['step' => 's']),
            'response' => new N404ErrorHandlerResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new N404ErrorHandlerResult([]),
        ]);
        [, $err] = N404ErrorHandlerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new N404ErrorHandlerSpec(['step' => 's']),
            'response' => new N404ErrorHandlerResponse(self::resp(200, ['v' => 1])),
            'result' => new N404ErrorHandlerResult([]),
        ]);
        [, $err] = N404ErrorHandlerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new N404ErrorHandlerSpec(['step' => 's']),
            'response' => new N404ErrorHandlerResponse(self::resp(200, ['v' => 2])),
            'result' => new N404ErrorHandlerResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        N404ErrorHandlerMakeResponse::call($ctx);
    ...
    {
        $preset = new N404ErrorHandlerResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new N404ErrorHandlerSpec([]),
            'response' => new N404ErrorHandlerResponse([]),
            'result' => new N404ErrorHandlerResult([]),
        ...
        [$got, $err] = N404ErrorHandlerMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new N404ErrorHandlerResult([])]);
        [, $err] = N404ErrorHandlerMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new N404ErrorHandlerSpec([]), 'result' => null]);
        [, $err] = N404ErrorHandlerMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new N404ErrorHandlerSpec(['step' => 's']),
            'result' => new N404ErrorHandlerResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new N404ErrorHandlerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = N404ErrorHandlerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new N404ErrorHandlerSpec(['step' => 's']),
            'result' => new N404ErrorHandlerResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new N404ErrorHandlerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = N404ErrorHandlerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new N404ErrorHandlerResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new N404ErrorHandlerSpec([]),
            'result' => new N404ErrorHandlerResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = N404ErrorHandlerMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = N404ErrorHandlerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new N404ErrorHandlerError('boom', 'boom');
        $utility->fetcher = function (N404ErrorHandlerContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new N404ErrorHandlerSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = N404ErrorHandlerMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (N404ErrorHandlerContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = N404ErrorHandlerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(N404ErrorHandlerResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        N404ErrorHandlerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (N404ErrorHandlerContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new N404ErrorHandlerSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = N404ErrorHandlerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new N404ErrorHandlerResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new N404ErrorHandlerSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = N404ErrorHandlerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = N404ErrorHandlerMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = N404ErrorHandlerMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new N404ErrorHandlerResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, N404ErrorHandlerDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new N404ErrorHandlerResult(['ok' => false])]);
        $this->expectException(N404ErrorHandlerError::class);
        N404ErrorHandlerDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new N404ErrorHandlerResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', N404ErrorHandlerMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        N404ErrorHandlerMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new N404ErrorHandlerBaseFeature();
        $b = new N404ErrorHandlerBaseFeature();
        N404ErrorHandlerFeatureAdd::call($ctx, $a);
        N404ErrorHandlerFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): N404ErrorHandlerBaseFeature
    {
        $f = new N404ErrorHandlerBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        N404ErrorHandlerFeatureAdd::call($ctx, self::named_feature('a'));
        N404ErrorHandlerFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        N404ErrorHandlerFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        N404ErrorHandlerFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        N404ErrorHandlerFeatureAdd::call($ctx, $replace);
        ...
        N404ErrorHandlerFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): N404ErrorHandlerContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new N404ErrorHandlerSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = N404ErrorHandlerPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        N404ErrorHandlerPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new N404ErrorHandlerResponse(['headers' => null]),
            'result' => new N404ErrorHandlerResult([]),
        ]);
        N404ErrorHandlerResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        N404ErrorHandlerResultBody::call($ctx);
