...
// N404ErrorHandler SDK streaming feature
...
class N404ErrorHandlerStreamingFeature extends N404ErrorHandlerBaseFeature
{
    ...
    private function _iterate(N404ErrorHandlerResult $result): \Generator
    {
    ...
    private function _streamable(N404ErrorHandlerContext $ctx): bool
    {
