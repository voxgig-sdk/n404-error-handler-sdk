...
// N404ErrorHandler SDK audit feature
...
class N404ErrorHandlerAuditFeature extends N404ErrorHandlerBaseFeature
{
    ...
    private function _emit(N404ErrorHandlerContext $ctx, string $outcome): void
    {
