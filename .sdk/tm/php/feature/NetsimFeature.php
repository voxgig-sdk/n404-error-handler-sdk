...
// N404ErrorHandler SDK netsim feature
...
class N404ErrorHandlerNetsimFeature extends N404ErrorHandlerBaseFeature
{
    ...
    private function _simulate(N404ErrorHandlerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(N404ErrorHandlerContext $ctx, array $applied): void
    {
        $client = $this->client;
