...
// N404ErrorHandler SDK timeout feature
...
class N404ErrorHandlerTimeoutFeature extends N404ErrorHandlerBaseFeature
{
    ...
    private function _with_timeout(N404ErrorHandlerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(N404ErrorHandlerContext $_ctx, float $ms): void
    {
        $client = $this->client;
