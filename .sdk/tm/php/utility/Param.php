...
// N404ErrorHandler SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class N404ErrorHandlerParam
{
    public static function call(N404ErrorHandlerContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = N404ErrorHandlerHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
