...
// N404ErrorHandler SDK utility: make_options

class N404ErrorHandlerMakeOptions
{
    ...
    public static function call(N404ErrorHandlerContext $ctx): array
    {
        ...
        //
        // `N404ErrorHandlerSchema::optspec()` is built from the model:
        ...
        $optspec = N404ErrorHandlerSchema::optspec();
