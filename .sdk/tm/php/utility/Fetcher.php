...
// N404ErrorHandler SDK utility: fetcher

class N404ErrorHandlerFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; N404ErrorHandlerSDK/1.0)';
    ...
    public static function call(N404ErrorHandlerContext $ctx, string $fullurl, array $fetchdef): array
    {
