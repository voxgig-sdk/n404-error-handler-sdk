...
from projectname_sdk.core.control import N404ErrorHandlerControl
...
class N404ErrorHandlerContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = N404ErrorHandlerControl()
        ...
        if isinstance(sp, N404ErrorHandlerSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, N404ErrorHandlerResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, N404ErrorHandlerResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return N404ErrorHandlerOperation({})
    ...
    def make_error(self, code, msg):
        return N404ErrorHandlerError(code, msg, self)
