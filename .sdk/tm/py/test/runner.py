...
class N404ErrorHandlerTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = N404ErrorHandlerTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = N404ErrorHandlerTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = N404ErrorHandlerTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
