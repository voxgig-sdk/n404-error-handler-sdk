...
from projectname_sdk import N404ErrorHandlerSDK
from projectname_sdk.core.spec import N404ErrorHandlerSpec
from projectname_sdk.core.result import N404ErrorHandlerResult
from projectname_sdk.core.response import N404ErrorHandlerResponse
from projectname_sdk.core.operation import N404ErrorHandlerOperation
from projectname_sdk.core.error import N404ErrorHandlerError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import N404ErrorHandlerBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return N404ErrorHandlerError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except N404ErrorHandlerError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = N404ErrorHandlerResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = N404ErrorHandlerSDK.test(None, None)
        ...
        class TestInitFeature(N404ErrorHandlerBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(N404ErrorHandlerBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = N404ErrorHandlerSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = N404ErrorHandlerSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = N404ErrorHandlerSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = N404ErrorHandlerSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = N404ErrorHandlerOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = N404ErrorHandlerSDK.test(None, setup_opts)
