...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/n404-error-handler` | `npm install @voxgig-sdk/n404-error-handler` |
| Python | `voxgig-sdk-n404-error-handler` | `pip install voxgig-sdk-n404-error-handler` |
| PHP | `voxgig-sdk/n404-error-handler` | `composer require voxgig-sdk/n404-error-handler` |
| Golang | `github.com/voxgig-sdk/n404-error-handler-sdk/go` | `go get github.com/voxgig-sdk/n404-error-handler-sdk/go` |
| Ruby | `voxgig-sdk-n404-error-handler` | `gem install voxgig-sdk-n404-error-handler` |
| Lua | `voxgig-sdk-n404-error-handler` | `luarocks install voxgig-sdk-n404-error-handler` |
