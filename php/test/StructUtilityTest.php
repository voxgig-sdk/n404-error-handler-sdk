...
// N404ErrorHandler SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = N404ErrorHandlerOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(N404ErrorHandlerOmni::structfix($now, Struct::undef()))
                        !== json_encode(N404ErrorHandlerOmni::structfix($val, Struct::undef()))) {
