...
// N404ErrorHandler SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (N404ErrorHandlerSDK::test)
...
{
    private const SDK_CLASS = 'N404ErrorHandlerSDK';
    ...
    private const SDK_BASE = 'n404errorhandler_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../n404errorhandler_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
