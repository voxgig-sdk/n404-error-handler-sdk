...
// N404ErrorHandler SDK utility: graphql
//
...
class N404ErrorHandlerGraphql
{
    ...
    // equivalent.
    public static function body(N404ErrorHandlerContext $ctx): mixed
    {
    ...
    public static function errors(N404ErrorHandlerContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
