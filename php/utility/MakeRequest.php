...
// N404ErrorHandler SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class N404ErrorHandlerMakeRequest
{
    public static function call(N404ErrorHandlerContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new N404ErrorHandlerResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new N404ErrorHandlerResponse($fetched);
        } else {
