...
The PHP SDK for the N404ErrorHandler API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->ErrorHandling(null)->list(null, null);
...
[$result, $err] = $client->N404ErrorHandler(null)->load(
    ["id" => "test01"], null
);
