...
// N404ErrorHandler SDK rbac feature
...
class N404ErrorHandlerRbacFeature extends N404ErrorHandlerBaseFeature
{
    ...
    private function _required(N404ErrorHandlerContext $ctx): ?string
    {
    ...
    private function _reject(N404ErrorHandlerContext $ctx, string $required): void
    {
    ...
    private function _track(N404ErrorHandlerContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
