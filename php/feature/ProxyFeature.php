...
// N404ErrorHandler SDK proxy feature
...
class N404ErrorHandlerProxyFeature extends N404ErrorHandlerBaseFeature
{
    ...
    public function init(N404ErrorHandlerContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (N404ErrorHandlerContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
