...
// N404ErrorHandler SDK cache feature
...
class N404ErrorHandlerCacheFeature extends N404ErrorHandlerBaseFeature
{
    ...
    private function _through(N404ErrorHandlerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
