...
// N404ErrorHandler SDK clienttrack feature
...
class N404ErrorHandlerClienttrackFeature extends N404ErrorHandlerBaseFeature
{
    ...
    public function PostConstruct(N404ErrorHandlerContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'N404ErrorHandler-SDK';
