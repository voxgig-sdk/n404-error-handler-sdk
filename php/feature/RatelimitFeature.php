...
// N404ErrorHandler SDK ratelimit feature
...
class N404ErrorHandlerRatelimitFeature extends N404ErrorHandlerBaseFeature
{
    ...
    private function _acquire(N404ErrorHandlerContext $ctx): void
    {
    ...
    private function _track(N404ErrorHandlerContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
