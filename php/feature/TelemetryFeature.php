...
// N404ErrorHandler SDK telemetry feature
...
class N404ErrorHandlerTelemetryFeature extends N404ErrorHandlerBaseFeature
{
    ...
    private function _close(N404ErrorHandlerContext $ctx, bool $ok): void
    {
