...
// N404ErrorHandler SDK utility type

class N404ErrorHandlerUtility
{
    ...
    public static function copy(N404ErrorHandlerUtility $src): N404ErrorHandlerUtility
    {
        $u = new N404ErrorHandlerUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
