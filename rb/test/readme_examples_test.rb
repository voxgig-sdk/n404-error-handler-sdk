...
#      offline in seeded test mode (N404ErrorHandlerSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "N404ErrorHandler_sdk.rb")
  SDK_CLASS = "N404ErrorHandlerSDK"
