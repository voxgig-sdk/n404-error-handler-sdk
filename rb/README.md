...
The Ruby SDK for the N404ErrorHandler API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.N404ErrorHandler(nil).load(
  { "id" => "test01" }, nil
)
