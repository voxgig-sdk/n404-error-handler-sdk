...
Results: Successful response with 404 error analysis.
...
| --- | --- | --- | --- |
| ErrorHandling | `list` | `GET /404` | See reference |

## Connect to the API

- Production server: `http://ccdb.hemiola.com`
...
- `n404-error-handler_list`: List records for an entity. Supported entities: `error_handling`.
- `n404-error-handler_load`: Load one record for an entity. No active entity supports this operation.
