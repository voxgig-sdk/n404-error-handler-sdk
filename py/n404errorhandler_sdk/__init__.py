...
from n404errorhandler_sdk.utility import register

# Load features
from n404errorhandler_sdk.feature.base_feature import N404ErrorHandlerBaseFeature
from n404errorhandler_sdk.features import _has_feature, _make_feature
...
class N404ErrorHandlerSDK:
    ...
    def get_utility(self):
        return N404ErrorHandlerUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("N404ErrorHandlerSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def ErrorHandling(self, data=None) -> "ErrorHandlingEntity":
        ...
        from n404errorhandler_sdk.entity.error_handling_entity import ErrorHandlingEntity
