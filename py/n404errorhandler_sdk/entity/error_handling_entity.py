...
from n404errorhandler_sdk.n404errorhandler_types import (
    ErrorHandling,
...
class ErrorHandlingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ErrorHandlingEntity(self._client, opts)
    ...
    def data_get(self) -> ErrorHandling:
    ...
    def match_get(self) -> ErrorHandling:
