# N404ErrorHandler SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions N404ErrorHandlerSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both N404ErrorHandlerSDK(...) and N404ErrorHandlerSDK.test(...) become
#      N404ErrorHandlerSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "n404errorhandler_sdk"
_SDK_CLASS = "N404ErrorHandlerSDK"
