...
describe("ErrorHandlingDirect", function()
  it("should direct-list-error_handling", function()
    local setup = error_handling_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-error_handling", setup.live and "live" or "unit")
...
function error_handling_direct_setup(mockres)
