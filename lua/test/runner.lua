...
function runner.env_override(m)
  local live = runner.getenv("N404ERRORHANDLER_TEST_LIVE")
  local override = runner.getenv("N404ERRORHANDLER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("N404ERRORHANDLER_TEST_EXPLAIN")
