...
function runner.env_override(m)
  local live = runner.getenv("N404_ERROR_HANDLER_TEST_LIVE")
  local override = runner.getenv("N404_ERROR_HANDLER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("N404_ERROR_HANDLER_TEST_EXPLAIN")
