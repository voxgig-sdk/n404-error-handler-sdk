...
AQL-driven CLI and REPL for the N404ErrorHandler SDK. Positional arguments are
...
```sh
go build -o n404-error-handler-cli ./...
```
...
./n404-error-handler-cli load 1 error_handling
./n404-error-handler-cli load '{id:1}' error_handling
