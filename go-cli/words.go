...
func registerSDKWords(r *eng.Registry, client *sdk.N404ErrorHandlerSDK) {
...
func runOp(client *sdk.N404ErrorHandlerSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
